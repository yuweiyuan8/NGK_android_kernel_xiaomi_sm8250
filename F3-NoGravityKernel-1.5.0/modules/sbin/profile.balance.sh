...
echo "1420800" > /sys/module/cpu_input_boost/parameters/input_boost_freq_lp
...
echo "1785600" > /sys/module/cpu_input_boost/parameters/max_boost_freq_lp
echo "1286400" > /sys/module/cpu_input_boost/parameters/max_boost_freq_hp
echo "1286400" > /sys/module/cpu_input_boost/parameters/max_boost_freq_pp
...
echo "670" > /sys/class/kgsl/kgsl-3d0/max_clock_mhz
echo "670000000" > /sys/class/kgsl/kgsl-3d0/devfreq/max_freq
echo "670000000" > /sys/class/kgsl/kgsl-3d0/max_gpuclk
